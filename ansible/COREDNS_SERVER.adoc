...
1. https://electron-swamp.blogspot.com/2025/01/the-case-for-coreos-network.html[The Case for CoreOS]
1. https://electron-swamp.blogspot.com/2025/01/coreos-configuration-less-is-right.html[CoreOS Configuration: Less is the Right Amount]
1. https://electron-swamp.blogspot.com/2025/01/provisioning-coreos-h1first-childmargin.html[Provisioning CoreOS - Intel and Raspberry Pi 4]
...
* https://github.com/containers/quadlet[Quadlet] +
  The Quadlet project source repository **deprecated**
